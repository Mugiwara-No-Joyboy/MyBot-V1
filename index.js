...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+6285691409819@s.whatsapp.net"] //NOMOR WA LU
          ...
          case 'ping':
            ...
            break
                ...
                case 'quotemaker':
                 ...
                 case 'phlogo':
					...
					var gbl1 = gh.split("|")[0];
					var gbl2 = gh.split("|")[1];
					if (args.length < 1) return reply(' Lah,Teksnya mana ??')
					reply(mess.wait)
            ...
            break	
				...
				case 'tts':
					...
					rano = getRandom('.ogg')
					dtt.length > 300
					? reply('Idih Ogah ntar dikira ceramah 😤')
